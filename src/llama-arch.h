...
enum llm_kv {
    ...
    LLM_KV_ATTENTION_KEY_RESIDUAL_MIX_LORA_RANK, //hxa07d
    LLM_KV_ATTENTION_RWKV_LAYER_PATTERN, //hxa07d
    LLM_KV_ATTENTION_ENABLE_QK_NORM, //hxa07d
    LLM_KV_ATTENTION_NOPE_IN_RWKV, //hxa07e
...
enum llm_tensor {
    ...
    LLM_TENSOR_TIME_MIX_K0, //hxa07d
    LLM_TENSOR_TIME_MIX_K1, //hxa07d
    LLM_TENSOR_TIME_MIX_K2, //hxa07d
