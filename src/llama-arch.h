...
enum llm_kv {
    ...
    LLM_KV_ATTENTION_KEY_RESIDUAL_MIX_LORA_RANK, //hxa079
    LLM_KV_ATTENTION_RWKV_LAYER_PATTERN, //hxa079
    LLM_KV_ATTENTION_ENABLE_QK_NORM, //hxa079
...
enum llm_tensor {
    ...
    LLM_TENSOR_TIME_MIX_K0, //hxa079
    LLM_TENSOR_TIME_MIX_K1, //hxa079
    LLM_TENSOR_TIME_MIX_K2, //hxa079
