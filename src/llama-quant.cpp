...
static ggml_type llama_tensor_get_type(quantize_state_impl & qs, ggml_type new_type, const ggml_tensor * tensor, llama_ftype ftype) {
    ...
    if (name == tn(LLM_TENSOR_OUTPUT, "weight") || (!qs.has_output && name == tn(LLM_TENSOR_TOKEN_EMBD, "weight"))) {
        ...
        if (name.find("attn_v.weight") != std::string::npos || name.find("time_mix_value.weight") != std::string::npos ) {
        ...
        else if (name.find("attn_output.weight") != std::string::npos || name.find("time_mix_output.weight") != std::string::npos) {
    ...
    } else if (name.find("attn_v.weight") != std::string::npos || name.find("time_mix_value.weight") != std::string::npos ) {
        ...
        ++qs.i_attention_wv;
    } else if (name.find("attn_k.weight") != std::string::npos || name.find("time_mix_key.weight") != std::string::npos ) {
        if (qs.model.hparams.n_expert == 8) {
            // for the 8-expert model, bumping this to Q8_0 trades just ~128MB
            // TODO: explore better strategies
            new_type = GGML_TYPE_Q8_0;
    ...
    } else if (name.find("attn_q.weight") != std::string::npos|| name.find("time_mix_receptance.weight") != std::string::npos) {
