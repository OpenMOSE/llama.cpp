...
llm_build_rwkv07emoe::llm_build_rwkv07emoe(const llama_model & model, const llm_graph_params & params) : llm_graph_context(params) {        
        ...
        for (int il = 0; il < n_layer; ++il) {
            ...
            if (IsRWKV)
            {
                ...
                // //currently need fp32 for better results.
...
//                     ctx0,
//                     ggml_mul_mat(ctx0, layer.time_mix_w2, ggml_tanh_inplace(ctx0, ggml_mul_mat(ctx0, layer.time_mix_w1, r))),
//                     layer.time_mix_w0
//                 );
...
//                 ggml_tensor * g = ggml_mul_mat(ctx0, layer.time_mix_g2, ggml_sigmoid_inplace(ctx0, ggml_mul_mat(ctx0, layer.time_mix_g1, r)));
