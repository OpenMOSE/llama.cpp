...
@ModelBase.register("RWKV07DForCausalLM") 
class RWKV07DModel(TextModel):
    model_arch = gguf.MODEL_ARCH.RWKV07D
...
@ModelBase.register("RWKV07DMoEForCausalLM") 
class RWKV07DMoEModel(TextModel):
    model_arch = gguf.MODEL_ARCH.RWKV07DMOE
...
@ModelBase.register("RWKV07EForCausalLM") 
class RWKV07EModel(TextModel):
    model_arch = gguf.MODEL_ARCH.RWKV07E
...
@ModelBase.register("RWKV07EMoEForCausalLM") 
class RWKV07EMoEModel(TextModel):
    model_arch = gguf.MODEL_ARCH.RWKV07EMOE
